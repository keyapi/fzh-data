...
type: Index
title: EN_API — 文档索引
description: 物料组翻译、销售订单发货状态、销售出库追溯等 OKF 文档入口
tags: [en-api, erpnext, index]
timestamp: 2026-09-14
---

# EN_API — 文档索引

> Agent 日常读 [`../AGENT_HANDOFF.md`](../AGENT_HANDOFF.md)，或按专题：
>
> - 销售订单发货/未发状态 → [`../AGENT_HANDOFF_物料发货状态.md`](../AGENT_HANDOFF_物料发货状态.md)
> - 销售出库 → 物料移动追溯 → [`../AGENT_HANDOFF_DN追溯报表.md`](../AGENT_HANDOFF_DN追溯报表.md)
> - 物料组英文翻译 → [`../AGENT_HANDOFF_物料组翻译.md`](../AGENT_HANDOFF_物料组翻译.md)
