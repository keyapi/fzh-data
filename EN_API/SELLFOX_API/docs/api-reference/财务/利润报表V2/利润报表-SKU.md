...
info:
  ...
  version: 1.0.0
paths:
  /api/financial/v2/monthProfit/sku.json:
    post:
      summary: 利润报表-SKU
      deprecated: false
      description: 利润报表-SKU
      operationId: skuUsingPOST_1
      tags:
        - 财务/利润报表V2
        - 利润报表V2
      parameters:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/FinAmzMonthProfitSkuOpenParam'
      responses:
        '200':
          description: OK
          content:
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/1827046/apis/api-399397938-run
components:
  schemas:
    FinAmzMonthProfitSkuOpenParam:
      type: object
      required:
        - startDate
        - endDate
      properties:
        ...
        pageSize:
          ...
          examples:
            - 20
      title: FinAmzMonthProfitSkuOpenParam
      x-apifox-orders:
        - dateType
        - developers
        - searchType
