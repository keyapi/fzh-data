...
info:
  ...
  version: 1.0.0
paths:
  /api/financial/v2/monthProfit/developer.json:
    post:
      summary: 利润报表-开发员
      deprecated: false
      description: 利润报表-开发员
      operationId: developerUsingPOST_1
      tags:
        - 财务/利润报表V2
        - 利润报表V2
      parameters:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/FinAmzMonthProfitDeveloperOpenParam'
      responses:
        '200':
          description: OK
          content:
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/1827046/apis/api-399397932-run
components:
  schemas:
    FinAmzMonthProfitDeveloperOpenParam:
      type: object
      required:
        - startDate
        - endDate
      properties:
        ...
        pageSize:
          ...
          examples:
            - 20
      title: FinAmzMonthProfitDeveloperOpenParam
      x-apifox-orders:
        - dateType
        - developers
        - showOnMonth
