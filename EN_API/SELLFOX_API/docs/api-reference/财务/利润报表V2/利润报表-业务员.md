...
info:
  ...
  version: 1.0.0
paths:
  /api/financial/v2/monthProfit/salesMan.json:
    post:
      summary: 利润报表-业务员
      deprecated: false
      description: 利润报表-业务员
      operationId: salesManUsingPOST_1
      tags:
        - 财务/利润报表V2
        - 利润报表V2
      parameters:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/FinAmzMonthProfitSalesmanOpenParam'
      responses:
        '200':
          description: OK
          content:
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/1827046/apis/api-399397935-run
components:
  schemas:
    FinAmzMonthProfitSalesmanOpenParam:
      type: object
      required:
        - startDate
        - endDate
      properties:
        ...
        pageSize:
          ...
          examples:
            - 20
      title: FinAmzMonthProfitSalesmanOpenParam
      x-apifox-orders:
        - dateType
        - salesMansList
        - showOnMonth
