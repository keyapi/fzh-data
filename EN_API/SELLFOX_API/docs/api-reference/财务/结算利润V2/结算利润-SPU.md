...
info:
  ...
  version: 1.0.0
paths:
  /api/financial/v2/dailyProfit/spu.json:
    post:
      summary: 结算利润-SPU
      deprecated: false
      description: 结算利润-SPU
      operationId: spuUsingPOST
      tags:
        - 财务/结算利润V2
        - 结算利润V2
      parameters:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/FinAmzDailyProfitSpuOpenParam'
      responses:
        '200':
          description: OK
          content:
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/1827046/apis/api-399397930-run
components:
  schemas:
    FinAmzDailyProfitSpuOpenParam:
      type: object
      required:
        - startDate
        - endDate
      properties:
        ...
        pageSize:
          ...
          examples:
            - 20
      title: FinAmzDailyProfitSpuOpenParam
      x-apifox-orders:
        - dateType
        - developers
        - searchType
