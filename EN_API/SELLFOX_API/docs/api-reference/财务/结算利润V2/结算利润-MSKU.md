...
info:
  ...
  version: 1.0.0
paths:
  /api/financial/v2/dailyProfit/msku.json:
    post:
      summary: 结算利润-MSKU
      deprecated: false
      description: 结算利润-MSKU
      operationId: mskuUsingPOST
      tags:
        - 财务/结算利润V2
        - 结算利润V2
      parameters:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/FinAmzDailyProfitMskuOpenParam'
      responses:
        '200':
          description: OK
          content:
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/1827046/apis/api-399397925-run
components:
  schemas:
    FinAmzDailyProfitMskuOpenParam:
      type: object
      required:
        - startDate
        - endDate
      properties:
        ...
        pageSize:
          ...
          examples:
            - 20
      title: FinAmzDailyProfitMskuOpenParam
      x-apifox-orders:
        - dateType
        - salesManList
        - searchType
