...
info:
  ...
  version: 1.0.0
paths:
  /api/financial/walmartReport/queryPageShop.json:
    post:
      summary: Walmart利润报表-查询店铺
      deprecated: false
      description: ''
      operationId: getFinWalmartPageShopUsingPOST
      tags:
        - 多平台/财务
        - Walmart利润报表
      parameters:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/WalmartMskuDaySummaryShopOpenQo'
      responses:
        '200':
          description: OK
          content:
            '*/*':
              schema:
                $ref: >-
                  #/components/schemas/OpenResult%C2%ABWalmartReportPageShopOpenVo%C2%BB
          headers: {}
          x-apifox-name: 成功
        '201':
          description: Created
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/1827046/apis/api-365907921-run
components:
  schemas:
    WalmartMskuDaySummaryShopOpenQo:
      type: object
      required:
      ...
      title: WalmartMskuDaySummaryShopOpenQo
      x-apifox-orders:
        - transactionPostedStartDate
        - transactionPostedEndDate
        - shopId
      ...
      x-apifox-folder: ''
    OpenResult«WalmartReportPageShopOpenVo»:
      type: object
      properties:
        requestId:
          type: string
        ...
        msg:
          ...
          description: 错误信息
        data:
          $ref: '#/components/schemas/WalmartReportPageShopOpenVo'
        ts:
          type: integer
          format: int64
          description: 响应时间戳
      title: OpenResult«WalmartReportPageShopOpenVo»
      x-apifox-orders:
        - requestId
        - code
        - msg
      ...
      x-apifox-ignore-properties: []
      x-apifox-folder: ''
    WalmartReportPageShopOpenVo:
      type: object
      properties:
        rows:
          type: array
          items:
            $ref: '#/components/schemas/WalmartMskuDaySummaryShopOpenVo'
        totalPage:
          type: integer
          format: int32
          description: 总页数
        totalSize:
          ...
          format: int32
          description: 数据总条数
      title: WalmartReportPageShopOpenVo
      x-apifox-orders:
        - rows
        - totalPage
        - totalSize
      x-apifox-ignore-properties: []
      x-apifox-folder: ''
    WalmartMskuDaySummaryShopOpenVo:
      type: object
      properties:
        shopId:
          type: string
        ...
        evaluationFee:
          type: number
          description: 测评费用
      title: WalmartMskuDaySummaryShopOpenVo
      x-apifox-orders:
        - shopId
        - shopName
        - marketplaceName
