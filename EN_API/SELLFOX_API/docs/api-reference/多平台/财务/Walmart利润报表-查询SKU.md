...
info:
  ...
  version: 1.0.0
paths:
  /api/financial/walmartReport/queryPageSku.json:
    post:
      summary: Walmart利润报表-查询SKU
      deprecated: false
      description: ''
      operationId: getFinWalmartPageSkuUsingPOST
      tags:
        - 多平台/财务
        - Walmart利润报表
      parameters:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/WalmartMskuDaySummarySkuOpenQo'
      responses:
        '200':
          description: OK
          content:
            '*/*':
              schema:
                $ref: >-
                  #/components/schemas/OpenResult%C2%ABWalmartReportPageSkuOpenVo%C2%BB
          headers: {}
          x-apifox-name: 成功
        '201':
          description: Created
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/1827046/apis/api-365907922-run
components:
  schemas:
    WalmartMskuDaySummarySkuOpenQo:
      type: object
      required:
      ...
      title: WalmartMskuDaySummarySkuOpenQo
      x-apifox-orders:
        - transactionPostedStartDate
        - transactionPostedEndDate
        - shopId
    ...
    OpenResult«WalmartReportPageSkuOpenVo»:
      ...
      properties:
        ...
        msg:
          ...
          description: 错误信息
        data:
          $ref: '#/components/schemas/WalmartReportPageSkuOpenVo'
        ts:
          type: integer
          format: int64
          description: 响应时间戳
      title: OpenResult«WalmartReportPageSkuOpenVo»
      x-apifox-orders:
        - requestId
        - code
        - msg
    ...
    WalmartReportPageSkuOpenVo:
      ...
      properties:
        rows:
          type: array
          items:
            $ref: '#/components/schemas/WalmartMskuDaySummarySkuOpenVo'
        totalPage:
          type: integer
          format: int32
          description: 总页数
        totalSize:
          ...
          format: int32
          description: 数据总条数
      title: WalmartReportPageSkuOpenVo
      x-apifox-orders:
        - rows
        - totalPage
        - totalSize
    ...
    WalmartMskuDaySummarySkuOpenVo:
      ...
      properties:
        ...
        evaluationFee:
          type: number
          description: 测评费用
      title: WalmartMskuDaySummarySkuOpenVo
      x-apifox-orders:
        - image
        - shopId
        - msku
