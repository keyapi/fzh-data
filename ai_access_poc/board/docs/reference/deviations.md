...
| D3 | Campaign/Targeting 报表可拉，但 IvyeaOps **尚未 ingest**；bid 需 `spKeyword` 实体 | 降加 bid/预算在 UI 仍空 | Phase2 ingest | **2026-07-28**：缺口矩阵见 `specs/phase2-dataset-gap.md`；实体 API 已冒烟 |
