    ...
    post:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/CommodityEditOpenVo'
      responses:
        '200':
          description: OK
          content:
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/1827046/apis/api-51516597-run
components:
  schemas:
    CommodityEditOpenVo:
      type: object
      properties:
        ...
        id:
          type: string
          description: ID（ID和SKU二选一，优先使用ID）
        cartonHeight:
          type: string
          description: 箱规——高 单位为cm 支持两位小数
        sku:
          type: string
          description: sku（ID和SKU二选一，优先使用ID）
        cartonWeight:
          type: string
        ...
        devDate:
          type: string
          description: 开发时间，yyyy-MM-dd 空字符串则清空
          examples:
            - '2022-01-01'
        childSkus:
          type: array
