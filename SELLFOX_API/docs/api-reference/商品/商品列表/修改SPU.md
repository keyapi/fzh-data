...
info:
  ...
  version: 1.0.0
paths:
  /api/commodity/updateMultiattributeCommodityV2.json:
    post:
      summary: 修改SPU
      deprecated: false
      description: ''
      operationId: updateMultiattributeCommodityV2UsingPOST
      tags:
        - 商品/商品列表
        - 商品列表
      parameters:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/CommoditySpuEditOpenVo'
            example: ''
      responses:
        '200':
          description: OK
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/1827046/apis/api-51516601-run
components:
  schemas:
    CommoditySpuEditOpenVo:
      type: object
      properties:
        spu:
          type: string
        ...
        deleteCommodityIds:
          type: array
          description: 需要删除的子SKU的id
          items:
            type: integer
            format: int64
      title: CommoditySpuEditOpenVo
      x-apifox-orders:
        - spu
        - spuName
        - spuImgUrl
