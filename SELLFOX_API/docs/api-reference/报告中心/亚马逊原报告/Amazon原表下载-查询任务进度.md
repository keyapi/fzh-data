...
info:
  ...
  version: 1.0.0
paths:
  /api/report/center/pageList.json:
    post:
      summary: Amazon原表下载-查询任务进度
      deprecated: false
      description: ''
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/ReportCenterQueryOpenQo'
            example: ''
      responses:
        '200':
          description: ''
          content:
            application/json:
              schema:
                $ref: >-
                  #/components/schemas/OpenResult%C2%ABPage%C2%ABReportCenterOpenVo%C2%BB%C2%BB
          headers: {}
          x-apifox-name: OK
        '201':
          description: ''
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/1827046/apis/api-52761475-run
components:
  schemas:
    ReportCenterQueryOpenQo:
      type: object
      required:
        - reportType
        - dateType
      ...
      properties:
        ...
        states:
          type: array
          description: 报告状态,可选值:fail:处理失败;processing:处理中;success:处理成功
          items:
            type: string
        reportType:
          type: string
        ...
        dateType:
          type: string
          description: 搜索时间类型,可选值：createTime:创建请求时间;reportTime:报告生成时间
        startDate:
          type: string
      ...
      x-apifox-ignore-properties: []
      x-apifox-folder: ''
    OpenResult«Page«ReportCenterOpenVo»»:
      type: object
      properties:
        requestId:
          type: string
        ...
        msg:
          ...
          description: 错误信息
        data:
          $ref: '#/components/schemas/Page%C2%ABReportCenterOpenVo%C2%BB'
        ts:
          type: integer
          format: int64
          description: 响应时间戳
      title: OpenResult«Page«ReportCenterOpenVo»»
      x-apifox-orders:
        - requestId
        - code
        - msg
    ...
    Page«ReportCenterOpenVo»:
      ...
      properties:
        ...
        rows:
          ...
          description: 当前页数据
          items:
            $ref: '#/components/schemas/ReportCenterOpenVo'
      title: Page«ReportCenterOpenVo»
      x-apifox-orders:
        - pageNo
        - pageSize
        - totalPage
    ...
    ReportCenterOpenVo:
      ...
      properties:
        ...
        state:
          type: string
          description: 状态,processing:处理中;success:处理成功;fail:处理失败(可以尝试重新设置时间范围重试)
        processingStatus:
          type: string
          description: |-
            亚马逊返回的原始处理状态：
            已提交 ： Submitted 或者 \_SUBMITTED\_
            处理中 ： InProgress 或者 IN_PROGRESS 或者 IN_QUEUE
            已取消 ： Cancelled 或者 CANCELLED 或者 FATAL
            已结束 ： Done 或者 DONE
            无可用数据： DoneNoDate
        remark:
          type: string
