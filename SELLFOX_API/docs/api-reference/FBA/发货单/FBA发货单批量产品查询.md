...
info:
  ...
  version: 1.0.0
paths:
  /api/fba/shippingOrder/itemsBatch.json:
    post:
      summary: FBA发货单批量产品查询
      deprecated: false
      description: ''
      operationId: itemsBatchUsingPOST
      tags:
        - FBA/发货单
        - FBA
      parameters:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/ShippingOrderItemsBatchOpenQo'
            example: ''
      responses:
        '200':
          description: OK
          content:
            '*/*':
              schema:
                $ref: >-
                  #/components/schemas/OpenResult%C2%ABList%C2%ABShippingOrderItemBatchOpenVo%C2%BB%C2%BB
          headers: {}
          x-apifox-name: 成功
        '201':
          description: Created
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/1827046/apis/api-195576737-run
components:
  schemas:
    ShippingOrderItemsBatchOpenQo:
      type: object
      properties:
        shipSnList:
          type: array
          ...
          items:
            type: string
      title: ShippingOrderItemsBatchOpenQo
      x-apifox-orders:
        - shipSnList
      x-apifox-ignore-properties: []
      x-apifox-folder: ''
    OpenResult«List«ShippingOrderItemBatchOpenVo»»:
      type: object
      properties:
        requestId:
          type: string
        ...
        data:
          ...
          description: 数据
          items:
            $ref: '#/components/schemas/ShippingOrderItemBatchOpenVo'
        ts:
          type: integer
          format: int64
          description: 响应时间戳
      title: OpenResult«List«ShippingOrderItemBatchOpenVo»»
      x-apifox-orders:
        - requestId
        - code
        - msg
    ...
    ShippingOrderItemBatchOpenVo:
      ...
      title: ShippingOrderItemBatchOpenVo
      x-apifox-orders:
        - shipSn
        - items
      x-apifox-ignore-properties: []
