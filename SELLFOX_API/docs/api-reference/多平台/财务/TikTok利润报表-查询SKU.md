...
info:
  ...
  version: 1.0.0
paths:
  /api/financial/tkReport/queryPageSku.json:
    post:
      summary: TikTok利润报表-查询SKU
      deprecated: false
      description: ''
      operationId: getFinTkPageSkuUsingPOST
      tags:
        - 多平台/财务
        - TikTok利润报表
      parameters:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/TkMskuDaySummarySkuOpenQo'
      responses:
        '200':
          description: OK
          content:
            '*/*':
              schema:
                $ref: >-
                  #/components/schemas/OpenResult%C2%ABTkReportPageSkuOpenVo%C2%BB
          headers: {}
          x-apifox-name: 成功
        '201':
          description: Created
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/1827046/apis/api-365907916-run
components:
  schemas:
    TkMskuDaySummarySkuOpenQo:
      type: object
      required:
        - startDate
        - endDate
      ...
      title: TkMskuDaySummarySkuOpenQo
      x-apifox-orders:
        - startDate
        - endDate
        - shopIds
      ...
      x-apifox-folder: ''
    OpenResult«TkReportPageSkuOpenVo»:
      type: object
      properties:
        requestId:
          type: string
        ...
        msg:
          ...
          description: 错误信息
        data:
          $ref: '#/components/schemas/TkReportPageSkuOpenVo'
        ts:
          type: integer
          format: int64
          description: 响应时间戳
      title: OpenResult«TkReportPageSkuOpenVo»
      x-apifox-orders:
        - requestId
        - code
        - msg
      ...
      x-apifox-ignore-properties: []
      x-apifox-folder: ''
    TkReportPageSkuOpenVo:
      type: object
      properties:
        rows:
          type: array
          items:
            $ref: '#/components/schemas/TkMskuDaySummarySkuOpenVo'
        totalPage:
          type: integer
          format: int32
          description: 总页数
    ...
    TkMskuDaySummarySkuOpenVo:
      ...
      properties:
        ...
        evaluationFee:
          type: number
          description: 测评费用
      title: TkMskuDaySummarySkuOpenVo
      x-apifox-orders:
        - image
        - shopIds
        - mskuList
