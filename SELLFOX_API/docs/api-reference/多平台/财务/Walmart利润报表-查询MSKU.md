...
info:
  ...
  version: 1.0.0
paths:
  /api/financial/walmartReport/queryPageMsku.json:
    post:
      summary: Walmart利润报表-查询MSKU
      deprecated: false
      description: ''
      operationId: getFinWalmartPageMskuUsingPOST
      tags:
        - 多平台/财务
        - Walmart利润报表
      parameters:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/WalmartMskuDaySummaryMskuOpenQo'
      responses:
        '200':
          description: OK
          content:
            '*/*':
              schema:
                $ref: >-
                  #/components/schemas/OpenResult%C2%ABWalmartReportPageMskuOpenVo%C2%BB
          headers: {}
          x-apifox-name: 成功
        '201':
          description: Created
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/1827046/apis/api-365907919-run
components:
  schemas:
    WalmartMskuDaySummaryMskuOpenQo:
      type: object
      required:
      ...
      title: WalmartMskuDaySummaryMskuOpenQo
      x-apifox-orders:
        - transactionPostedStartDate
        - transactionPostedEndDate
        - shopId
      ...
      x-apifox-folder: ''
    OpenResult«WalmartReportPageMskuOpenVo»:
      type: object
      properties:
        requestId:
          type: string
        ...
        msg:
          ...
          description: 错误信息
        data:
          $ref: '#/components/schemas/WalmartReportPageMskuOpenVo'
        ts:
          type: integer
          format: int64
          description: 响应时间戳
      title: OpenResult«WalmartReportPageMskuOpenVo»
      x-apifox-orders:
        - requestId
        - code
        - msg
      ...
      x-apifox-ignore-properties: []
      x-apifox-folder: ''
    WalmartReportPageMskuOpenVo:
      type: object
      properties:
        rows:
          type: array
          items:
            $ref: '#/components/schemas/WalmartMskuDaySummaryMskuOpenVo'
        totalPage:
          type: integer
          format: int32
          description: 总页数
        totalSize:
          ...
          format: int32
          description: 数据总条数
      title: WalmartReportPageMskuOpenVo
      x-apifox-orders:
        - rows
        - totalPage
        - totalSize
      x-apifox-ignore-properties: []
      x-apifox-folder: ''
    WalmartMskuDaySummaryMskuOpenVo:
      type: object
      properties:
        image:
          type: string
        ...
        evaluationFee:
          type: number
          description: 测评费用
      title: WalmartMskuDaySummaryMskuOpenVo
      x-apifox-orders:
        - image
        - shopId
        - msku
