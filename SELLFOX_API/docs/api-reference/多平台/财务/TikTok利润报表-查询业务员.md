...
info:
  ...
  version: 1.0.0
paths:
  /api/financial/tkReport/querySalesMan.json:
    post:
      summary: TikTok利润报表-查询业务员
      deprecated: false
      description: ''
      operationId: getFinTkPageSalesManUsingPOST
      tags:
        - 多平台/财务
        - TikTok利润报表
      parameters:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/TkMskuDaySummarySalesManOpenQo'
      responses:
        '200':
          description: OK
          content:
            '*/*':
              schema:
                $ref: >-
                  #/components/schemas/OpenResult%C2%ABTkReportPageSalesManOpenVo%C2%BB
          headers: {}
          x-apifox-name: 成功
        '201':
          description: Created
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/1827046/apis/api-365907917-run
components:
  schemas:
    TkMskuDaySummarySalesManOpenQo:
      type: object
      required:
        - startDate
        - endDate
      properties:
        ...
        salesMans:
          ...
          items:
            type: string
      title: TkMskuDaySummarySalesManOpenQo
      x-apifox-orders:
        - startDate
        - endDate
        - shopIds
      ...
      x-apifox-folder: ''
    OpenResult«TkReportPageSalesManOpenVo»:
      type: object
      properties:
        requestId:
          type: string
        ...
        msg:
          ...
          description: 错误信息
        data:
          $ref: '#/components/schemas/TkReportPageSalesManOpenVo'
        ts:
          type: integer
          format: int64
          description: 响应时间戳
      title: OpenResult«TkReportPageSalesManOpenVo»
      x-apifox-orders:
        - requestId
        - code
        - msg
      ...
      x-apifox-ignore-properties: []
      x-apifox-folder: ''
    TkReportPageSalesManOpenVo:
      type: object
      properties:
        rows:
          type: array
          items:
            $ref: '#/components/schemas/TkMskuDaySummarySalesManOpenVo'
        totalPage:
          type: integer
          format: int32
          description: 总页数
        totalSize:
          ...
          format: int32
          description: 数据总条数
      title: TkReportPageSalesManOpenVo
      x-apifox-orders:
        - rows
        - totalPage
        - totalSize
      x-apifox-ignore-properties: []
      x-apifox-folder: ''
    TkMskuDaySummarySalesManOpenVo:
      type: object
      properties:
        salesManNameList:
          type: array
        ...
        evaluationFee:
          type: number
          description: 测评费用
      title: TkMskuDaySummarySalesManOpenVo
      x-apifox-orders:
        - salesManNameList
        - shopIds
        - salesQuantity
