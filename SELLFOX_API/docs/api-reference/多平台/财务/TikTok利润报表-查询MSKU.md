...
info:
  ...
  version: 1.0.0
paths:
  /api/financial/tkReport/queryPageMsku.json:
    post:
      summary: TikTok利润报表-查询MSKU
      deprecated: false
      description: ''
      operationId: getFinTkPageMskuUsingPOST
      tags:
        - 多平台/财务
        - TikTok利润报表
      parameters:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/TkMskuDaySummaryMskuOpenQo'
      responses:
        '200':
          description: OK
          content:
            '*/*':
              schema:
                $ref: >-
                  #/components/schemas/OpenResult%C2%ABTkReportPageMskuOpenVo%C2%BB
          headers: {}
          x-apifox-name: 成功
        '201':
          description: Created
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/1827046/apis/api-365907914-run
components:
  schemas:
    TkMskuDaySummaryMskuOpenQo:
      type: object
      required:
        - startDate
        - endDate
      ...
      title: TkMskuDaySummaryMskuOpenQo
      x-apifox-orders:
        - startDate
        - endDate
        - shopIds
      ...
      x-apifox-folder: ''
    OpenResult«TkReportPageMskuOpenVo»:
      type: object
      properties:
        requestId:
          type: string
        ...
        msg:
          ...
          description: 错误信息
        data:
          $ref: '#/components/schemas/TkReportPageMskuOpenVo'
        ts:
          type: integer
          format: int64
          description: 响应时间戳
      title: OpenResult«TkReportPageMskuOpenVo»
      x-apifox-orders:
        - requestId
        - code
        - msg
      ...
      x-apifox-ignore-properties: []
      x-apifox-folder: ''
    TkReportPageMskuOpenVo:
      type: object
      properties:
        rows:
          type: array
          items:
            $ref: '#/components/schemas/TkMskuDaySummaryMskuOpenVo'
        totalPage:
          type: integer
          format: int32
          description: 总页数
    ...
    TkMskuDaySummaryMskuOpenVo:
      ...
      properties:
        ...
        evaluationFee:
          type: number
          description: 测评费用
      title: TkMskuDaySummaryMskuOpenVo
      x-apifox-orders:
        - image
        - shopIds
        - mskuList
