...
info:
  ...
  version: 1.0.0
paths:
  /api/financial/tkReport/queryPageShop.json:
    post:
      summary: TikTok利润报表-查询店铺
      deprecated: false
      description: ''
      operationId: getFinTkPageShopUsingPOST
      tags:
        - 多平台/财务
        - TikTok利润报表
      parameters:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/TkMskuDaySummaryShopOpenQo'
      responses:
        '200':
          description: OK
          content:
            '*/*':
              schema:
                $ref: >-
                  #/components/schemas/OpenResult%C2%ABTkReportPageShopOpenVo%C2%BB
          headers: {}
          x-apifox-name: 成功
        '201':
          description: Created
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/1827046/apis/api-365907915-run
components:
  schemas:
    TkMskuDaySummaryShopOpenQo:
      type: object
      required:
        - startDate
        - endDate
      ...
      title: TkMskuDaySummaryShopOpenQo
      x-apifox-orders:
        - startDate
        - endDate
        - shopIds
      ...
      x-apifox-folder: ''
    OpenResult«TkReportPageShopOpenVo»:
      type: object
      properties:
        requestId:
          type: string
        ...
        msg:
          ...
          description: 错误信息
        data:
          $ref: '#/components/schemas/TkReportPageShopOpenVo'
        ts:
          type: integer
          format: int64
          description: 响应时间戳
      title: OpenResult«TkReportPageShopOpenVo»
      x-apifox-orders:
        - requestId
        - code
        - msg
      ...
      x-apifox-ignore-properties: []
      x-apifox-folder: ''
    TkReportPageShopOpenVo:
      type: object
      properties:
        rows:
          type: array
          items:
            $ref: '#/components/schemas/TkMskuDaySummaryShopOpenVo'
        totalPage:
          type: integer
          format: int32
          description: 总页数
    ...
    TkMskuDaySummaryShopOpenVo:
      ...
      properties:
        ...
        evaluationFee:
          type: number
          description: 测评费用
      title: TkMskuDaySummaryShopOpenVo
      x-apifox-orders:
        - shopIds
        - shopType
        - salesQuantity
