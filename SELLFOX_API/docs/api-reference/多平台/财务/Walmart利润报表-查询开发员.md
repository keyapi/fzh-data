...
info:
  ...
  version: 1.0.0
paths:
  /api/financial/walmartReport/queryPageDeveloper.json:
    post:
      summary: Walmart利润报表-查询开发员
      deprecated: false
      description: ''
      operationId: getFinWalmartPageDeveloperUsingPOST
      tags:
        - 多平台/财务
        - Walmart利润报表
      parameters:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/WalmartMskuDaySummaryDeveloperOpenQo'
      responses:
        '200':
          description: OK
          content:
            '*/*':
              schema:
                $ref: >-
                  #/components/schemas/OpenResult%C2%ABWalmartReportPageDeveloperOpenVo%C2%BB
          headers: {}
          x-apifox-name: 成功
        '201':
          description: Created
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/1827046/apis/api-365907918-run
components:
  schemas:
    WalmartMskuDaySummaryDeveloperOpenQo:
      type: object
      required:
      ...
      properties:
        ...
        developers:
          ...
          items:
            type: string
      title: WalmartMskuDaySummaryDeveloperOpenQo
      x-apifox-orders:
        - transactionPostedStartDate
        - transactionPostedEndDate
        - shopId
      ...
      x-apifox-folder: ''
    OpenResult«WalmartReportPageDeveloperOpenVo»:
      type: object
      properties:
        requestId:
          type: string
        ...
        msg:
          ...
          description: 错误信息
        data:
          $ref: '#/components/schemas/WalmartReportPageDeveloperOpenVo'
        ts:
          type: integer
          format: int64
          description: 响应时间戳
      title: OpenResult«WalmartReportPageDeveloperOpenVo»
      x-apifox-orders:
        - requestId
        - code
        - msg
      ...
      x-apifox-ignore-properties: []
      x-apifox-folder: ''
    WalmartReportPageDeveloperOpenVo:
      type: object
      properties:
        rows:
          type: array
          items:
            $ref: '#/components/schemas/WalmartMskuDaySummaryDeveloperOpenVo'
        totalPage:
          type: integer
          format: int32
          description: 总页数
        totalSize:
          ...
          format: int32
          description: 数据总条数
      title: WalmartReportPageDeveloperOpenVo
      x-apifox-orders:
        - rows
        - totalPage
        - totalSize
      x-apifox-ignore-properties: []
      x-apifox-folder: ''
    WalmartMskuDaySummaryDeveloperOpenVo:
      type: object
      properties:
        developerNameList:
          type: array
        ...
        evaluationFee:
          type: number
          description: 测评费用
      title: WalmartMskuDaySummaryDeveloperOpenVo
      x-apifox-orders:
        - developerNameList
        - shopId
        - salesQty
