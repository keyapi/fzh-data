...
info:
  ...
  version: 1.0.0
paths:
  /api/financial/v2/monthProfit/asin.json:
    post:
      summary: 利润报表-ASIN
      deprecated: false
      description: 利润报表-ASIN
      operationId: asinUsingPOST_1
      tags:
        - 财务/利润报表V2
        - 利润报表V2
      parameters:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/FinAmzMonthProfitAsinOpenParam'
      responses:
        '200':
          description: OK
          content:
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/1827046/apis/api-399397931-run
components:
  schemas:
    FinAmzMonthProfitAsinOpenParam:
      type: object
      required:
        - startDate
        - endDate
      properties:
        ...
        pageSize:
          ...
          examples:
            - 20
      title: FinAmzMonthProfitAsinOpenParam
      x-apifox-orders:
        - dateType
        - mergeAsin
        - salesManList
