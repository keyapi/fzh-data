...
info:
  ...
  version: 1.0.0
paths:
  /api/financial/v2/monthProfit/parentAsin.json:
    post:
      summary: 利润报表-父ASIN
      deprecated: false
      description: 利润报表-父ASIN
      operationId: parentAsinUsingPOST_1
      tags:
        - 财务/利润报表V2
        - 利润报表V2
      parameters:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/FinAmzMonthProfitParentAsinOpenParam'
      responses:
        '200':
          description: OK
          content:
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/1827046/apis/api-399397934-run
components:
  schemas:
    FinAmzMonthProfitParentAsinOpenParam:
      type: object
      required:
        - startDate
        - endDate
      properties:
        ...
        salesManList:
          type: array
          description: 业务员,多个批量查询，格式：格式：["1","2"]
          items:
            type: string
        showOnMonth:
          type: boolean
        ...
        pageSize:
          ...
          examples:
            - 20
      title: FinAmzMonthProfitParentAsinOpenParam
      x-apifox-orders:
        - dateType
        - mergeAsin
        - salesManList
