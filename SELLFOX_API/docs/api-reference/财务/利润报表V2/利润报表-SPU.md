...
info:
  ...
  version: 1.0.0
paths:
  /api/financial/v2/monthProfit/spu.json:
    post:
      summary: 利润报表-SPU
      deprecated: false
      description: 利润报表-SPU
      operationId: spuUsingPOST_1
      tags:
        - 财务/利润报表V2
        - 利润报表V2
      parameters:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/FinAmzMonthProfitSpuOpenParam'
      responses:
        '200':
          description: OK
          content:
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/1827046/apis/api-399397939-run
components:
  schemas:
    FinAmzMonthProfitSpuOpenParam:
      type: object
      required:
        - startDate
        - endDate
      properties:
        ...
        pageSize:
          ...
          examples:
            - 20
      title: FinAmzMonthProfitSpuOpenParam
      x-apifox-orders:
        - dateType
        - spuDevelopers
        - searchType
