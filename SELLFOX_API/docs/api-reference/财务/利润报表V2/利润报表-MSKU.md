...
info:
  ...
  version: 1.0.0
paths:
  /api/financial/v2/monthProfit/msku.json:
    post:
      summary: 利润报表-MSKU
      deprecated: false
      description: 利润报表-MSKU
      operationId: mskuUsingPOST_1
      tags:
        - 财务/利润报表V2
        - 利润报表V2
      parameters:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/FinAmzMonthProfitMskuOpenParam'
      responses:
        '200':
          description: OK
          content:
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/1827046/apis/api-399397933-run
components:
  schemas:
    FinAmzMonthProfitMskuOpenParam:
      type: object
      required:
        - startDate
        - endDate
      properties:
        ...
        operateStatusIds:
          type: array
          description: 产品运营状态ID,格式:[1,2]
          items:
            type: integer
            format: int64
        devStatusIds:
          type: array
          description: 产品开发状态ID,格式:[1,2]
          items:
            type: integer
            format: int64
        pageNo:
