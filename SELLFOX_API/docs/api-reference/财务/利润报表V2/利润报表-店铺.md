...
info:
  ...
  version: 1.0.0
paths:
  /api/financial/v2/monthProfit/shop.json:
    post:
      summary: 利润报表-店铺
      deprecated: false
      description: 利润报表-店铺
      operationId: shopUsingPOST_1
      tags:
        - 财务/利润报表V2
        - 利润报表V2
      parameters:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/FinAmzMonthProfitShopOpenParam'
      responses:
        '200':
          description: OK
          content:
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/1827046/apis/api-399397936-run
components:
  schemas:
    FinAmzMonthProfitShopOpenParam:
      type: object
      required:
        - startDate
        - endDate
      properties:
        ...
        pageSize:
          ...
          examples:
            - 20
      title: FinAmzMonthProfitShopOpenParam
      x-apifox-orders:
        - dateType
        - showOnMonth
        - showOnDay
