...
info:
  ...
  version: 1.0.0
paths:
  /api/financial/v2/dailyProfit/asin.json:
    post:
      summary: 结算利润-ASIN
      deprecated: false
      description: 结算利润-ASIN
      operationId: asinUsingPOST
      tags:
        - 财务/结算利润V2
        - 结算利润V2
      parameters:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/FinAmzDailyProfitAsinOpenParam'
      responses:
        '200':
          description: OK
          content:
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/1827046/apis/api-399397923-run
components:
  schemas:
    FinAmzDailyProfitAsinOpenParam:
      type: object
      required:
        - startDate
        - endDate
      properties:
        ...
        pageSize:
          ...
          examples:
            - 20
      title: FinAmzDailyProfitAsinOpenParam
      x-apifox-orders:
        - dateType
        - mergeAsin
        - salesManList
