...
info:
  ...
  version: 1.0.0
paths:
  /api/financial/v2/dailyProfit/shop.json:
    post:
      summary: 结算利润-店铺
      deprecated: false
      description: 结算利润-店铺
      operationId: shopUsingPOST
      tags:
        - 财务/结算利润V2
        - 结算利润V2
      parameters:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/FinAmzDailyProfitShopOpenParam'
      responses:
        '200':
          description: OK
          content:
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/1827046/apis/api-399397928-run
components:
  schemas:
    FinAmzDailyProfitShopOpenParam:
      type: object
      required:
        - startDate
        - endDate
      properties:
        ...
        pageSize:
          ...
          examples:
            - 20
      title: FinAmzDailyProfitShopOpenParam
      x-apifox-orders:
        - dateType
        - showOnMonth
        - showOnDay
