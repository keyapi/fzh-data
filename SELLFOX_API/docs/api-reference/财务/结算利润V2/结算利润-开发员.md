...
info:
  ...
  version: 1.0.0
paths:
  /api/financial/v2/dailyProfit/developer.json:
    post:
      summary: 结算利润-开发员
      deprecated: false
      description: 结算利润-开发员
      operationId: developerUsingPOST
      tags:
        - 财务/结算利润V2
        - 结算利润V2
      parameters:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/FinAmzDailyProfitDeveloperOpenParam'
      responses:
        '200':
          description: OK
          content:
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/1827046/apis/api-399397924-run
components:
  schemas:
    FinAmzDailyProfitDeveloperOpenParam:
      type: object
      required:
        - startDate
        - endDate
      properties:
        ...
        pageSize:
          ...
          examples:
            - 20
      title: FinAmzDailyProfitDeveloperOpenParam
      x-apifox-orders:
        - dateType
        - developers
        - showOnMonth
