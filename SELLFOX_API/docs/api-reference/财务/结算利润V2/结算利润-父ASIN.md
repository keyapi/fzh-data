...
info:
  ...
  version: 1.0.0
paths:
  /api/financial/v2/dailyProfit/parentAsin.json:
    post:
      summary: 结算利润-父ASIN
      deprecated: false
      description: 结算利润-父ASIN
      operationId: parentAsinUsingPOST
      tags:
        - 财务/结算利润V2
        - 结算利润V2
      parameters:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/FinAmzDailyProfitParentAsinOpenParam'
      responses:
        '200':
          description: OK
          content:
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/1827046/apis/api-399397926-run
components:
  schemas:
    FinAmzDailyProfitParentAsinOpenParam:
      type: object
      required:
        - startDate
        - endDate
