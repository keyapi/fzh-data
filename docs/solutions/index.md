...
| 日期 | 标题 | 文件 |
|------|------|------|
| 2026-09-15 | 判断模块「当前配置」的可信来源顺序 — `.codex_tmp/` 快照与脱敏文档都不是现值 | [documentation-gaps/module-current-config-source-of-truth.md](documentation-gaps/module-current-config-source-of-truth.md) |
