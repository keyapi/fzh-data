...
> 2026-08-19 生产已部署 e2ee454 并重建 KS0443 12 个套件；赛狐 24 个旧组合已删，12 个正式组合已按 sellfox-combo-create 重建并回读。套件日常维护：`combo-ops.md`（操作手册）+ `SELLFOX_API/AGENT_HANDOFF.md`（热区冻结）。`FXLSSF3030` 长期跳过；KS0003/KS0395 已确认无问题（2026-08-20）。
