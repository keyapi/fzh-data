...
| 元素 | 坐标（mm 或 pt） | 说明 |
|------|------------------|------|
| SKUxQTY #1 | 旋转后在 (205mm, 190mm) | 上半页标注 |
| SKUxQTY #2 | 旋转后在 (170mm, 50mm) | 下半页标注 |
| `---→` | (195mm,165mm)、(195mm,280mm) | 指向裁切位置 |
| `←---` | (36mm,75mm) | 同上 |
| 时间戳 | (66mm,215mm)、(420pt,815pt) | `%Y-%m-%d %H:%M:%S` |
| `✂` | (20pt,815pt)、(20pt,440pt) | 裁切标记（Helvetica 无此字形，与 Colab 一致） |
...
| 标签 PDF | 页数一致；差异仅 `x=382..396` 一条竖带 = **时间戳文字**（我的运行时刻 vs Colab 的 16:44） |
| 页面几何 | mediabox / cropbox / `/Rotate`、图片 bbox **完全一致** |
