...
| 步骤 0：库存预检（SPS 原始订单 CSV → checked CSV + 操作表） | [../stock_precheck.py](../stock_precheck.py) |
| 命令行入口（薄适配器） | [../run_pb_orders.py](../run_pb_orders.py) · [../run_stock_check.py](../run_stock_check.py) |
